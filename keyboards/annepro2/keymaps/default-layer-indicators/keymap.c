...
void esc_tap_dance(qk_tap_dance_state_t *state, void *user_data){
  switch(state->count) {
    case 1:
      tap_code(KC_ESC);
      break;
    case 2:
      if(layer_state_is(_AOE_LAYER)) layer_off(_AOE_LAYER);
      else tap_code(KC_ESC);
      break;
    case 3:
      tap_code(KC_CAPS);
      break;
...
qk_tap_dance_action_t tap_dance_actions[] = {
  [TD_ESC] = ACTION_TAP_DANCE_FN(esc_tap_dance),
  [TD_CTRL_SHIFT] = ACTION_TAP_DANCE_DOUBLE(KC_RCTL, KC_RSFT),
};
  ...
  * |-----------------------------------------------------------------------------------------+
  * | Shift  |  q  | w  |  e  |  r  |  t  |  y  |  u  |  i  |  o  | PS | HOME | END |    \    |
  * |-----------------------------------------------------------------------------------------+
 ...
 [_FN1_LAYER] = KEYMAP( /* Base */
    ...
    KC_LSFT, _______, VIM_W , _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_HOME, KC_END, _______,
    _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_PGUP, KC_PGDN, _______,
    _______, _______, _______, CTL_INS, SFT_INS, VIM_B, _______, _______, _______, KC_INS, KC_DEL, _______,
 ...
 [_FN2_LAYER] = KEYMAP( /* Base */
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, _______,
  ...
  * |-----------------------------------------------------------------------------------------+
  * | Ctrl  |  L1   |  Alt  |           space           |  Ctr/Shift  |  Left  | Down | Right |
  * \-----------------------------------------------------------------------------------------/
  */
 [_AOE_LAYER] = KEYMAP( /* Base */
    TD(TD_ESC), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_DEL,
    KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS,
    LT(_FN1_LAYER,KC_CAPS), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_UP,
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, TD(TD_CTRL_SHIFT), KC_LEFT, KC_DOWN, KC_RGHT
),
};
...
bool led_update_user(led_t leds) {
  if (leds.caps_lock) {
    ...
    if(layer_state_is(_AOE_LAYER)) annepro2LedSetForegroundColor(0x00, 0xFF, 0xFF);
    else if(!layer_state_is(_FN1_LAYER) && !layer_state_is(_FN2_LAYER)) {
      annepro2LedResetForegroundColor();
    }
  }
